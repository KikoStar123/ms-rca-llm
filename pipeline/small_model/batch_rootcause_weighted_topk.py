...
from small_model_rootcause_weighted_topk import load_events, parse_time
...
def main() -> None:
    parser = argparse.ArgumentParser(description="批量评估加权根因Top-K基线")
    ...
    for target_date in dates:
        ...
        report_path = output_dir / f"rootcause_weighted_topk_{target_date:%Y_%m_%d}_report.json"
